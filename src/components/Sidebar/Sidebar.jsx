...
import { getIcon, getSunTime, getWeekDayFull } from "../../utils/util";
    ...
    <div className="sidebar">
      <div className="sidebar-up">
        ...
        <div className="sidebar-day">
          {getWeekDayFull(current?.dt)} , {getSunTime(current.dt)}
        </div>
      </div>
      <div className="sidebar-down">
        <div className="sidebar-text">
          {current.weather.map((weather, index) => (
            <div key={index} className="sidebar-weather-up">
              {" "}
              <img
